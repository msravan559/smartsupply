        ...
        <View style={styles.section}>
          ...
          <View style={styles.storeContainer}>
            ...
            <Text style={styles.customerheading}>
              Day to Day Inventory - Pet Report
            </Text>
          </View>
          ...
          <View style={styles.table}>
            <View style={styles.tableRow}>
              ...
              <View style={styles.tableColHeader}>
                <Text>Total Loaded</Text>
              </View>
              <View style={styles.tableColHeader}>
                <Text>Delivered</Text>
              </View>
              <View style={styles.tableColHeader}>
                <Text>Returned Filled </Text>
              </View>
              <View style={styles.tableColHeader}>
                <Text>Collected Empty </Text>
              </View>
              <View style={styles.tableColHeader}>
                <Text>Calculate Unloaded </Text>
              </View>
              <View style={styles.tableColHeader}>
                <Text>Actual Unloaded </Text>
              </View>
            </View>
            <View style={styles.tableRow}>
